...
void plot(TH1F* h1, TH1F* h2, TH1F* h3){
    ...
    h1->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_noCher.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_noCher.png");

    h2->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_tpb_noCher.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_tpb_noCher.png");

    h3->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lyso_noCher.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lyso_noCher.png");
}
...
//	std::cout << "sigma: "  << h1->GetFunction("gauF1")->GetParameter(2) << std::endl;
	...
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_noCher.pdf");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_noCher.png");
}
