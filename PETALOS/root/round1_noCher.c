...
void plotX(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/x_lxe_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/x_tpb_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/x_lyso_noCher.png");
...
void plotY(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/y_lxe_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/y_tpb_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/y_lyso_noCher.png");
...
void plotZ(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/z_lxe_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/z_tpb_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/z_lyso_noCher.png");
	...
	leg->Draw("same");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/z_combined_noCher.png");
...
void plotT(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/t_lxe_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/t_tpb_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/t_lyso_noCher.png");
...
void plotNPhotons(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/nphotons_lxe_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/nphotons_tpb_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/nphotons_lyso_noCher.png");
...
void plotCRT(TFile *fIn1, TFile* fIn2, TFile* fIn3){
    ...
    TH1F *h2 = (TH1F*) fIn2->Get("DTOF.DTOF");
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/crt_lxe_nFixed_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/crt_tpb_nFixed_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/crt_lyso_nFixed_noCher.png");
...
void plotCRTCombined(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/crt_nFixed_noCher.png");
...
void plotFirstPE(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/firstPE_lxe_nFixed_noCher.png");
	h2->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/firstPE_tpb_nFixed_noCher.png");
	h3->Draw();
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/firstPE_lyso_nFixed_noCher.png");
	...
	leg->AddEntry(h3, "LYSO", "lp");
	leg->Draw("same");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/firstPE_nFixed_noCher.png");
...
void plotXY(TFile *fIn1, TFile* fIn2, TFile* fIn3){
	...
	h1->Draw("colz");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/xy_lxe_noCher.png");
	h2->Draw("colz");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/xy_tpb_noCher.png");
	h3->Draw("colz");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/round1/xy_lyso_noCher.png");
