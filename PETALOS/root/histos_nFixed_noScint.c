...
void plot(TH1F* h1, TH1F* h2, TH1F* h3){
    ...
    h1->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lxe_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lxe_noScint.png");

    h2->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lxe_tpb_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lxe_tpb_noScint.png");

    h3->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lyso_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_lyso_noScint.png");
}
