...
/*
    ...
    TH1F *h1 = (TH1F*) fIn2.Get("NFirst.Time_1_PEBox1");
    TH1F *h2 = (TH1F*) fIn2.Get("NFirst.Time_2_PEBox1");
    TH1F *h3 = (TH1F*) fIn2.Get("NFirst.Time_3_PEBox1");
    TH1F *h4 = (TH1F*) fIn2.Get("NFirst.Time_4_PEBox1");
    TH1F *h5 = (TH1F*) fIn2.Get("NFirst.Time_5_PEBox1");
    TH1F *h6 = (TH1F*) fIn2.Get("NFirst.Time_6_PEBox1");
    TH1F *h7 = (TH1F*) fIn2.Get("NFirst.Time_7_PEBox1");
    TH1F *h8 = (TH1F*) fIn2.Get("NFirst.Time_8_PEBox1");
*/
...
//    h8->Draw("same");
	...
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/nfirst/nfirst_lxe.png");
//	c1->Print("/home/jmbenlloch/next/petalo/work/histo/nfirst/nfirst_tpb.png");
}
