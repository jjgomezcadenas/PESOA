...
void histos_pde(){
	...
	//			h1->Scale(1/h1->Integral(), "width");
				...
				std::string pathHisto = "/home/jmbenlloch/next/petalo/work/histo/pde/fits/";
...
//	leg_noCher->AddEntry(gTpb_noCher, "LXe-TPB", "lp");
	...
	c3->Print("/home/jmbenlloch/next/petalo/PESOA/PETALOS/root/paper/plots/CRTvsPDELXeLYSONoJitterFstPE.png");

	c3->Clear();

	// LXe + TPB
	gTpb_noCher->SetTitle("");
	gTpb_noCher->GetXaxis().SetTitle("PDE (%)");
	gTpb_noCher->GetXaxis()->SetLimits(0.,100.);
	gTpb_noCher->GetYaxis().SetTitle("CRT (ps)");
	gTpb_noCher->SetMinimum(0.);
	gTpb_noCher->SetMaximum(250.);
	//grerrplot(gTpb_noCher);
	//grerrplot(gLxe_noCher);
	gTpb_noCher->Draw();
	gLxe_noCher->Draw("same");
...
//	leg_noCher->AddEntry(gLyso_noCher, "LYSO", "lp");
	...
	c3->Print("/home/jmbenlloch/next/petalo/PESOA/PETALOS/root/paper/plots/CRTvsPDELXeTPBNoJitter.png");
