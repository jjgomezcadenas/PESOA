void histos_phys_noScint(){
    TFile *fIn1 = new TFile("/home/jmbenlloch/next/petalo/work/histo/LXe_VUV3mm_xy2.4cm_z5cm_PHYS_noScint_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
    TFile *fIn2 = new TFile("/home/jmbenlloch/next/petalo/work/histo/LXe_TPB3mm_xy2.4cm_z5cm_PHYS_noScint_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
    TFile *fIn3 = new TFile("/home/jmbenlloch/next/petalo/work/histo/LYSO_VUV3mm_xy2.4cm_z5cm_PHYS_noScint_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
...
void plot(TH1F* h1, TH1F* h2, TH1F* h3){
    ...
    h1->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_noScint.png");

    h2->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_tpb_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lxe_tpb_noScint.png");

    h3->Draw();
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lyso_noScint.pdf");
	c2->Print("/home/jmbenlloch/next/petalo/work/histo/crt_phys_lyso_noScint.png");
}
